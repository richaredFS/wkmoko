...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-12-11 17:41:28
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(1, '今天天气还不错', '耳边的风，轻轻的吹。', '2018-11-22', 1, 1),
(2, '哈哈', '嘻嘻哈哈', '2018-11-22', 1, 1),
(4, '童年', '我想问，是什么陪伴着我们成长呢？是家长、是朋友、是美食、还是一本一本叠成山的书本？不，都不是的，是那值得我们去回忆的童年，在童年里，你还记得 第一次学会走路、学会才饭、学会说话吗？你还记得第一次去外面旅行、第一次去上学、第一次帮爸妈做家务事等那些美好的时刻吗？可能当时我没有好好地去记在日记上，可我的脑海里却已经深深地记住了。', '2018-11-23', 1, 1),
(6, '  这是一朵极普通的花！', '  这是一朵极普通的花，普通得谁也记不清它的名字，只知道它春天开花的日子，田埂和塘堤四处可见它的踪影。花的颜色很朴素，介于红白之间。虽不鲜艳，却别有一番动人的妩媚。香气也不浓郁，但那若有若无、若远若近的芳馨，更叫人沉醉；花的体积也并不庞大，像那婴儿小拳头的样子，让人一望就怜爱不已。      那小蜜蜂就在这朵花的花蕊中安静地休息着，一动不动。偶尔微风袭来，轻轻拂起它柔软的翅膀，但它却仍在沉沉地小睡，仿佛在做着一个甜甜的梦。这小蜜蜂竟把小憩的地方安排在花蕊里。难道它也不知道应该把灵魂寄放在美好而洁静的地方吗？      小蜜蜂静静地在花蕊里睡着。美和美相互映衬，简直就是一帧绝美的静物画。      灵魂歇息的地方，其实不一定需要广阔堂皇的空间，有一朵美好而洁净的花其实也就静了。灵魂也吸有在这样的花或者花一样的地方，才能心安理得地悄然入睡，才能远远地避开邪恶与危险，才能得到生生不息的力量、勇气和信心，从而在生活的旅途上更加坚强有力地昂首向前迈进。      如果我们总是沮丧颓废或烦躁不安，那一定是我们还没有像那只小蜜蜂那样找到属于自己的那朵花！！！！！ok好的。。', '2018-11-24', 1, 1),
(7, '秋叶思雨', '秋天的夜，还是一如既往的深沉，安静得不沾染一丝喧嚣的气息，这沉寂的感觉有点浪漫，有点孤单。淡然的感受风滑过指尖的微凉，它将带着你的灵魂轻轻地飘进我的梦乡。依稀的霓虹灯照亮了思绪，滴落在我想念你的路上，斑驳的月光洗礼着我心底爱你的痕迹，最后成为我梦里的依稀。', '2018-11-25', 1, 1),
(8, '时光杂谈', '时光轻逝，那些季节，我们曾不遗余力地去追寻；那些岁月，我们勇于承受敢作敢当\r\n\r\n时光回转，那些片段，我们有过一起繁华的邂逅；那些风景，我们赐予它完美的结局\r\n\r\n时光的路口，孤单、幸福、迷茫、辛酸、内疚、快乐，每一次的得到，就代表着每一次的失去，每一次的领悟，就代表着每一次的痛楚，每一次的渴望，每一次的感受，简单、单纯、安慰、寄托，然后离开了。。。', '2018-11-28', 3, 1),
(9, '测试标题', '哈哈哈哈哈，测试一下测试一下测试一下测试一下测试一下测试一下测试一下测试一下测试一下测试一下', '2018-11-26', 6, 1),
(10, 'awk 入门教程', 'awk是处理文本文件的一个应用程序，几乎所有 Linux 系统都自带这个程序。', '2018-11-22', 1, 1),
(11, '谈谈 Java 类加载机制', '最近在学习 Tomcat 架构，其中很重要的一个模块是类加载器，因为以前学习的不够深入，所以趁这个机会好好把类加载机制搞明白。', '2018-11-22', 1, 1),
...
(100001, '百度', 'baidu', '123456789', '13800138009', NULL, '中国北京'),
...
CREATE TABLE IF NOT EXISTS `moko` (
  ...
  `hair` char(10) DEFAULT NULL,
  `eye` char(10) DEFAULT NULL,
  `userid` int(11) DEFAULT NULL,
  PRIMARY KEY (`mokoid`),
  KEY `mked` (`userid`)
...
(10001, 'chenzi', 'chenzi', '2018-12-13', '女', 'chenzi41@163.com', '23801138001', 'images/37f99e305e4f45b6b845d4e3332defb8.png', '中国 广东省 东莞市', '喜欢拍照，特别喜欢表现自我'),
(10002, 'LeiNa', '12345', '1995-10-16', '女', 'leina@163.com', '13414503051', 'images/b13342c045114146a70feafc8e63dad9.png', '中国 广东省 东莞市', '平面拍摄 电商拍摄 工作室拍摄'),
...
(10005, 'K9999', '12345', '2018-12-21', NULL, 'king@12.com', '13414503051', 'images/a773cf24cc9d47b28d7756872b786822.jpg', '中国 广东省 东莞市', '喜欢拍照，特别喜欢表现自我'),
...
(10012, 'qqqw', 'qqqw', '2018-12-03', NULL, 'king@qq.com', '13800138000', 'images/05dea9148c4a4a7aae42bc8f9f59cbd0.jpg', '中国 广东省 东莞市', '喜欢拍照，特别喜欢表现自我'),
...
(10026, '凯莎', 'kaisha', '2018-11-29', NULL, 'qianqiu@qq.com', '13800138000', NULL, '天使星云', '维护天使的正义。'),
...
(10029, 'proya', 'proya', '1995-11-17', NULL, 'proya@qq.com', '13414503051', NULL, '中国 广东 广州', '手握日月摘形成，时间无我这般人。'),
(10035, 'ymk', 'asdasd', '2018-12-05', NULL, '103659195@qq.com', '15111', '', 'asd', 'asd'),
